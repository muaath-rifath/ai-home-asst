...
import { APIOptions } from './builder/APIClientBuilder';
import { BrowserOptions } from './builder/TokenClientBuilder';
import { CredentialsOptions } from './builder/CredentialsClientBuilder';
import { ICloudClient, IMultiPropertiesCloudClient, ISinglePropertyCloudClient } from './client/ICloudClient';
declare const ArduinoIoTCloud: import("./builder/IArduinoIoTCloudFactory").IArduinoIoTCloudFactory;
export { SenML };
