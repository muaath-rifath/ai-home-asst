...
export declare type ConnectionOptions = mqtt.IClientOptions;
export declare type CloudMessage = {
    topic: string;
    propertyName?: string;
    value: CloudMessageValue;
};
export declare const BaseConnectionOptions: Partial<ConnectionOptions>;
export interface IConnection {
    ...
    publish(topic: string, message: string | Buffer, opts: mqtt.IClientPublishOptions, callback?: mqtt.PacketCallback): IConnection;
